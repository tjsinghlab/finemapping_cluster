...
write_tsv(gwasEUR, "/gpfs/commons/groups/nygcfaculty/lappalainen_singh/finemapping_cluster/data/RA.EUR.assoc")
```
...
write_tsv(gwasEUR, "/gpfs/commons/groups/nygcfaculty/lappalainen_singh/finemapping_cluster/data/T1D.EUR.assoc")
```
