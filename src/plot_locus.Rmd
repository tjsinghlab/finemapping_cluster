...
```{r}
source("/gpfs/commons/groups/nygcfaculty/lappalainen_singh/finemapping_cluster/src/post_finemapping_functions.R")
...
ss_path <- paste0("/gpfs/commons/groups/nygcfaculty/lappalainen_singh/finemapping_cluster/", paste0("output/", sumstats_name, "/", ld_pop, "_",
...
ld_path = paste0("/gpfs/commons/groups/nygcfaculty/lappalainen_singh/finemapping_cluster/",paste0("output/", sumstats_name, "/", ld_pop, "_",
...
ggsave(paste0("/gpfs/commons/groups/nygcfaculty/lappalainen_singh/finemapping_cluster/analysis/", paste(STUDY, LOCUS, LD_REF, WINDOW_MB, sep = "_"), ".pdf"), width = 10, height = 6)
```
